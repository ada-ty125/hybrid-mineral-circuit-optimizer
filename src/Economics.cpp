...
double fixed_op_cost(const CircuitDescriptor& circuit,
  ...
  return econ.op_cost_type_A_per_s * circuit.n_A +
         econ.op_cost_type_B_per_s * circuit.n_B;
}
...
double economic_value(const Stream& pal_product,
  ...
  const double revenue =
      econ.pal_in_pal_stream * pal_product.pal +
      econ.gor_in_pal_stream * pal_product.gor +
      econ.waste_in_pal_stream * pal_product.waste +
      econ.pal_in_gor_stream * gor_product.pal +
      econ.gor_in_gor_stream * gor_product.gor +
      econ.waste_in_gor_stream * gor_product.waste;
